...
```{r}
# temp <- readRDS("Temp010825.RDA")
temp <- readRDS("Temp011425.RDA")
```
...
```{r}
substance_list <- c("halluc_p", "lsd_ever", "psilcy_ever", "ecstasy_ever", "ket_ever", "pcp_ever", "mesc_ever", "dmt_ever", "salv_ever","mj_ever", "coc_ever", "meth_ever", "stm_ever", "trq_ever", "inh_ever", "sed_ever", "herflag", "pnranyflag", "any_opi")
...
```{r, eval = FALSE }
# 2015 - 2019
ud_regress_a(paste("halluc_p" ," + "  , m1vars, " + " , policy19))

# 2020 - 2022
ud_regress_b(paste("halluc_p" ," + "  , m1vars, " + ",  policy23))
```
...
# 2015 - 2019
use_regress_b("mrjyr", paste("halluc_p", " + ", m2vars))

# 2020 - 2022
use_regress_a("mrjyr", paste("halluc_p", " + ", m2vars))
```
...
# 2015 - 2019
use_regress_b("mrjyr", paste("halluc_p", " + ", m3vars))

# 2020 - 2022
use_regress_a("mrjyr", paste("halluc_p", " + ", m3vars))
...
use_regress_b("mrj_use_f", paste("halluc_p", " + ", m1vars))
use_regress_a("mrj_use_f", paste("halluc_p", " + ", m1vars))
```
...
# 2015 - 2019
use_regress_b("mrj_use_f", paste("halluc_p", " + ", m2vars))

# 2020 - 2022
use_regress_a("mrj_use_f", paste("halluc_p", " + ", m2vars))
```
...
# 2015 - 2019
use_regress_b("mrj_use_f", paste("halluc_p", " + ", m3vars))

# 2020 - 2022
use_regress_a("mrj_use_f", paste("halluc_p", " + ", m3vars))
...
# 2015 - 2019
use_regress_b("mrj_use_f", paste("halluc_p", " + ", m1vars, " + ", policy19))

# 2020 - 2022
use_regress_a("mrj_use_f", paste("halluc_p", " + ", m1vars, " + ", policy23))
```
